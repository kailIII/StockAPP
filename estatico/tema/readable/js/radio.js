...
(function ($) {'use strict';
    $('audio[controls]').before(function () {
        ...
        $(data_toggle).addClass('btn btn-primary btn-lg btn-block row col-sm-12');
        ...
        var load_error = function () {
            ...
            $(player_box).find('.glyphicon-refresh').parent().attr('title', 'Se ha producido un error al cargar el audio.');
        ...
        var addPlay = function () {
            ...
            $(play).addClass('btn  btn-primary disabled col-sm-1');
            ...
            var loadCheck = setInterval(function () {
                ...
                if (song.networkState === 3 || timeout === 100) {
                    ...
                    console.log('No se encontró fuente de audio o se ha producido un tiempo de espera');
                    load_error();
                    clearInterval(loadCheck);
                    return false;
                }
        ...
        var addTime = function () {
            ...
            time.showtime = function () {
                var position_title = 'Haga clic para Restablecer<hr style="padding:0; margin:0;" />Posici&oacute;n: ';
                var length_title = 'Haga clic para Restablecer<hr style="padding:0; margin:0;" />Duraci&oacute;n: ';
                if (!song.paused) {
