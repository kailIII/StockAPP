 ...
 */
 jQuery.fn.extend({Calculadora: function(op) {
					...
					defaults = {
						TituloHTML:'<button class="btn-block btn3d btn btn-success" target="_blank">Calculadora</button>',
					...
					Botones=op.Botones;
					Signos=op.Signos;
                    $(LaCalculadora).append('<input type="text" class="'+op.ClasetxtSalida+'" id="'+op.txtSalida+'" placeholder="0" >');
