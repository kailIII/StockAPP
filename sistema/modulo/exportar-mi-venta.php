...
while ($row = $result->fetch_assoc())
{
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('C'.$colnum, '¢ '.$Vendedor->FormatoSaldo($row["cantidad"]*70));
    $objPHPExcel->getActiveSheet()->SetCellValue('D'.$colnum, $row["numerototal"]);
	// Borde Tabla Excel
	$styleArray = array(
		'borders' => array(
			'allborders' => array(
